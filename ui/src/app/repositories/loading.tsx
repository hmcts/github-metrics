...
/**
 * The landing page's bones: the organisation header, the four estate figures, the readiness donut
 * and the repositories table, in that order and at those sizes.
 *
